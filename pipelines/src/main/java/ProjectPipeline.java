 ...
 */
public class ProjectPipeline implements Runnable {

    public final static String STREAMS_ID = "ProjectPipeline";

    private final static Logger LOGGER = LoggerFactory.getLogger(ProjectPipeline.class);
    ...
    public static void main(String[] args)
    {
        ...
        ProjectPipeline personPipeline = new ProjectPipeline();
    ...
    public void run() {
        ...
        builder.newReadCurrentStream("project", projectProvider);
        builder.addStreamsPersistWriter(GraphPersistWriter.STREAMS_ID, graphPersistWriter, 1, "project");
        builder.start();
    }
}
